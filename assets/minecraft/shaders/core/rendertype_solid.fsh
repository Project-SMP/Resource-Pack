...
void main() {
    ...
    if( vertexDistance < 10 ){
        color[0] += (1.2 - 0.12 * vertexDistance) / (16 + 32 * vertexColor[0] * color[0]);
        color[1] += (1.2 - 0.12 * vertexDistance) / (16 + 32 * vertexColor[1] * color[1]);
        color[2] += (1.2 - 0.12 * vertexDistance) / (16 + 32 * vertexColor[2] * color[2]);
    }
